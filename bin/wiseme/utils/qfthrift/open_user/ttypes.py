...
class Profile(object):
  ...
  def __init__(self, user_id=None, nickname=None, avatar=None, signature=None, bgimageurl=None, gender=None, birthday=None, country=None, province=None, city=None, mobile=None, unionid=None, mark=None, create_time=None, update_time=None, openid=None,):
